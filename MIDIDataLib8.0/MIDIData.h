/******************************************************************************/
/*                                                                            */
/*　MIDIData.h - MIDIDataヘッダーファイル                  (C)2002-2021 くず  */
/*                                                                            */
/******************************************************************************/
...
typedef struct tagMIDIEvent {
	...
	void* m_pUser1;                     /* ユーザー用自由領域1(未使用) */
	void* m_pUser2;                     /* ユーザー用自由領域2(未使用) */
	void* m_pUser3;                     /* ユーザー用自由領域3(未使用) */
	void* m_pUser4;                     /* ユーザー用自由領域4(未使用) */
} MIDIEvent;
...
#define MIDIEVENT_MAXTEMPO     (16777216)
...
#define MIDIEVENT_NOCHARCODE         0 /* 指定なし */
#define MIDIEVENT_NOCHARCODELATIN    (0x10000 | 1252) /* 指定なしだが、{@LATIN} (ANSI)であるものと推定される。 */
#define MIDIEVENT_NOCHARCODEJP       (0x10000 | 932) /* 指定なしだが、{@JP} (Shift-JIS)であるものと推定される。 */
#define MIDIEVENT_NOCHARCODEUTF16LE  (0x10000 | 1200) /* 指定なしだが、UTF16リトルエンディアンであるものと推定される。 */
#define MIDIEVENT_NOCHARCODEUTF16BE  (0x10000 | 1201) /* 指定なしだが、UTF16ビッグエンディアンであるものと推定される。 */
#define MIDIEVENT_NOCHARCODEUTF8     (0x10000 | 65001) /* 指定なしだが、UTF8であるものと推定される。 */
#define MIDIEVENT_LATIN              1252 /* {@LATIN} (ANSI)*/
#define MIDIEVENT_JP                 932 /* {@JP} (Shift-JIS) */
#define MIDIEVENT_UTF16LE            1200 /* UTF16リトルエンディアン */
#define MIDIEVENT_UTF16BE            1201 /* UTF16ビッグエンディアン */
#define MIDIEVENT_UTF8               65001 /* UTF8 */
...
#ifdef UNICODE
#define MIDIEvent_CreateTextBasedEvent MIDIEvent_CreateTextBasedEventW
#else
#define MIDIEvent_CreateTextBasedEvent MIDIEvent_CreateTextBasedEventA
#endif
...
#ifdef UNICODE
#define MIDIEvent_CreateTextBasedEventEx MIDIEvent_CreateTextBasedEventExW
#else
#define MIDIEvent_CreateTextBasedEventEx MIDIEvent_CreateTextBasedEventExA
#endif
...
#ifdef UNICODE
#define MIDIEvent_CreateTextEventEx MIDIEvent_CreateTextEventExW
#else
#define MIDIEvent_CreateTextEventEx MIDIEvent_CreateTextEventExA
#endif
...
(long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDIEvent_CreateCopyrightNoticeEx MIDIEvent_CreateCopyrightNoticeExW
#else
#define MIDIEvent_CreateCopyrightNoticeEx MIDIEvent_CreateCopyrightNoticeExA
#endif
...
(long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDIEvent_CreateTrackNameEx MIDIEvent_CreateTrackNameExW
#else
#define MIDIEvent_CreateTrackNameEx MIDIEvent_CreateTrackNameExA
#endif
...
(long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDIEvent_CreateInstrumentNameEx MIDIEvent_CreateInstrumentNameExW
#else
#define MIDIEvent_CreateInstrumentNameEx MIDIEvent_CreateInstrumentNameExA
#endif
...
(long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDIEvent_CreateLyricEx MIDIEvent_CreateLyricExW
#else
#define MIDIEvent_CreateLyricEx MIDIEvent_CreateLyricExA
#endif
...
(long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDIEvent_CreateMarkerEx MIDIEvent_CreateMarkerExW
#else
#define MIDIEvent_CreateMarkerEx MIDIEvent_CreateMarkerExA
#endif
...
(long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDIEvent_CreateCuePointEx MIDIEvent_CreateCuePointExW
#else
#define MIDIEvent_CreateCuePointEx MIDIEvent_CreateCuePointExA
#endif
...
(long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDIEvent_CreateProgramNameEx MIDIEvent_CreateProgramNameExW
#else
#define MIDIEvent_CreateProgramNameEx MIDIEvent_CreateProgramNameExA
#endif
...
(long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDIEvent_CreateDeviceNameEx MIDIEvent_CreateDeviceNameExW
#else
#define MIDIEvent_CreateDeviceNameEx MIDIEvent_CreateDeviceNameExA
#endif
...
long __stdcall MIDIEvent_GetCharCode (MIDIEvent* pMIDIEvent);

/* イベントの文字コードを設定(テキスト・著作権・トラック名・インストゥルメント名・ */
/* 歌詞・マーカー・キューポイント・プログラム名・デバイス名のみ) */
long __stdcall MIDIEvent_SetCharCode (MIDIEvent* pMIDIEvent, long lCharCode);
...
(MIDITrack* pMIDITrack, long lTime, long lKind, const char* pszText);
long __stdcall MIDITrack_InsertTextBasedEventW
(MIDITrack* pMIDITrack, long lTime, long lKind, const wchar_t* pszText);
#ifdef UNICODE
#define MIDITrack_InsertTextBasedEvent MIDITrack_InsertTextBasedEventW
#else
#define MIDITrack_InsertTextBasedEvent MIDITrack_InsertTextBasedEventA
#endif

/* トラックにテキストベースのイベントを生成して挿入(文字コード指定あり) */
long __stdcall MIDITrack_InsertTextBasedEventExA
(MIDITrack* pMIDITrack, long lTime, long lKind, long lCharCode, const char* pszText);
long __stdcall MIDITrack_InsertTextBasedEventExW
(MIDITrack* pMIDITrack, long lTime, long lKind, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDITrack_InsertTextBasedEventEx MIDITrack_InsertTextBasedEventExW
#else
#define MIDITrack_InsertTextBasedEventEx MIDITrack_InsertTextBasedEventExA
#endif
...
(MIDITrack* pMIDITrack, long lTime, long lCharCode, const char* pszText);
long __stdcall MIDITrack_InsertTextEventExW
(MIDITrack* pMIDITrack, long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDITrack_InsertTextEventEx MIDITrack_InsertTextEventExW
#else
#define MIDITrack_InsertTextEventEx MIDITrack_InsertTextEventExA
#endif
...
(MIDITrack* pMIDITrack, long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDITrack_InsertCopyrightNoticeEx MIDITrack_InsertCopyrightNoticeExW
#else
#define MIDITrack_InsertCopyrightNoticeEx MIDITrack_InsertCopyrightNoticeExA
#endif
...
(MIDITrack* pMIDITrack, long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDITrack_InsertTrackNameEx MIDITrack_InsertTrackNameExW
#else
#define MIDITrack_InsertTrackNameEx MIDITrack_InsertTrackNameExA
#endif
...
(MIDITrack* pMIDITrack, long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDITrack_InsertInstrumentNameEx MIDITrack_InsertInstrumentNameExW
#else
#define MIDITrack_InsertInstrumentNameEx MIDITrack_InsertInstrumentNameExA
#endif
...
(MIDITrack* pMIDITrack, long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDITrack_InsertLyricEx MIDITrack_InsertLyricExW
#else
#define MIDITrack_InsertLyricEx MIDITrack_InsertLyricExA
#endif
...
(MIDITrack* pMIDITrack, long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDITrack_InsertMarkerEx MIDITrack_InsertMarkerExW
#else
#define MIDITrack_InsertMarkerEx MIDITrack_InsertMarkerExA
#endif
...
(MIDITrack* pMIDITrack, long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDITrack_InsertCuePointEx MIDITrack_InsertCuePointExW
#else
#define MIDITrack_InsertCuePointEx MIDITrack_InsertCuePointExA
#endif
...
#ifdef UNICODE
#define MIDITrack_InsertProgramNameEx MIDITrack_InsertProgramNameExW
#else
#define MIDITrack_InsertProgramNameEx MIDITrack_InsertProgramNameExA
#endif
...
(MIDITrack* pTrack, long lTime, long lCharCode, const wchar_t* pszText);
#ifdef UNICODE
#define MIDITrack_InsertDeviceNameEx MIDITrack_InsertDeviceNameExW
#else
#define MIDITrack_InsertDeviceNameEx MIDITrack_InsertDeviceNameExA
#endif
...
#ifdef UNICODE
#define MIDIData_LoadFromWRK MIDIData_LoadFromWRKW
#else
#define MIDIData_LoadFromWRK MIDIData_LoadFromWRKA
#endif
...
#ifdef UNICODE
#define MIDIData_LoadFromMabiMML MIDIData_LoadFromMabiMMLW
#else
#define MIDIData_LoadFromMabiMML MIDIData_LoadFromMabiMMLA
#endif
